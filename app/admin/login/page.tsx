...
export default function AdminLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Set session cookie so middleware can check auth
      ...
      >
        ...
        <div className="text-center mb-8">
          <p className="font-display font-bold text-3xl text-white">
            T<span className="text-emerald-400">T</span>
        ...
        <div className="bg-[#111] border border-[#222] rounded-2xl p-7">
          <div className="flex items-center gap-2 mb-6">
            <div className="w-8 h-8 bg-emerald-500/10 border border-emerald-500/20 rounded-lg flex items-center justify-center">
              <FiLock size={14} className="text-emerald-400" />
            </div>
            <div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-[#161616] border border-[#252525] focus:border-emerald-500/50 text-white placeholder-slate-600 rounded-xl pl-9 pr-4 py-3 text-sm outline-none transition-colors"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full bg-[#161616] border border-[#252525] focus:border-emerald-500/50 text-white placeholder-slate-600 rounded-xl pl-9 pr-10 py-3 text-sm outline-none transition-colors"
                />
                <button
                  type="button"
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full flex items-center justify-center gap-2 bg-emerald-500 hover:bg-emerald-400 disabled:bg-emerald-500/50 disabled:cursor-not-allowed text-white font-semibold py-3 rounded-xl transition-colors text-sm mt-1"
            >
              {loading ? (
